    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "lora_path": ("STRING", {"default": "", "multiline": True}),
                "lora_scale": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 2.0, "step": 0.01}),
                "extra_lora": ("STRING", {"default": "", "multiline": True}),
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "lora_weights_transformer": ("STRING", {"default": "", "multiline": True}),
                "lora_scale_transformer": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 3.0, "step": 0.01}),
                "lora_weights_transformer_2": ("STRING", {"default": "", "multiline": True}),
