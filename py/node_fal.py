    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "lora1_url": ("STRING", {"default": "", "multiline": True, "tooltip": "LoRA 1 URL"}),
                "lora1_weight": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 2.0, "step": 0.1, "tooltip": "LoRA 1 weight"}),
                "lora2_url": ("STRING", {"default": "", "multiline": True, "tooltip": "LoRA 2 URL"}),
                "lora2_weight": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 2.0, "step": 0.1, "tooltip": "LoRA 2 weight"}),
                "lora3_url": ("STRING", {"default": "", "multiline": True, "tooltip": "LoRA 3 URL"}),
